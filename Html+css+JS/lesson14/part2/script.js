...
function showNumbersBetween() {
    ...
    const min = Math.min(num1, num2); // פונקציה של מינמום 
    const max = Math.max(num1, num2); // פונקציה של מקסימום 
